...
export function AdminPageClient({ 
    ...
    }, [user, authLoading, router, seedCategories, getSiteContentAction, toast]);
    ...
    const handleSaveContent = async () => {
        ...
        try {
            ...
            if (homePageContent.heroImagePath) {
                formData.append('existingHeroImagePath', homePageContent.heroImagePath);
            }
